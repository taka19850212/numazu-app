...
<head>
  ...
  <meta name="description"
    content="Bespoke luxury travel experiences crafted exclusively for the world's most discerning travelers. Private jets, exclusive villas, and unforgettable journeys.">
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500&family=Montserrat:wght@300;400;500&display=swap"
    rel="stylesheet">
...
<body class="antialiased">
    ...
    <div class="container mx-auto px-6 lg:px-12">
      <div class="flex items-center justify-between">
        ...
        <nav class="hidden lg:flex items-center gap-10">
          <a href="#destinations"
            class="text-sm font-montserrat tracking-[0.15em] text-charcoal/80 hover:text-charcoal transition-colors duration-300 uppercase">Destinations</a>
          <a href="#experiences"
            class="text-sm font-montserrat tracking-[0.15em] text-charcoal/80 hover:text-charcoal transition-colors duration-300 uppercase">Experiences</a>
          <a href="#villas"
            class="text-sm font-montserrat tracking-[0.15em] text-charcoal/80 hover:text-charcoal transition-colors duration-300 uppercase">Private
            Villas</a>
          <a href="#about"
            class="text-sm font-montserrat tracking-[0.15em] text-charcoal/80 hover:text-charcoal transition-colors duration-300 uppercase">Our
            Story</a>
          <a href="#inquire"
            class="text-sm font-montserrat tracking-[0.15em] text-charcoal/80 hover:text-charcoal transition-colors duration-300 uppercase">Contact</a>
        </nav>

        <!-- CTA Button -->
        <div class="hidden lg:block">
          <a href="#inquire"
            class="inline-flex items-center gap-2 px-6 py-3 border border-charcoal text-sm font-montserrat tracking-[0.15em] uppercase text-charcoal hover:bg-charcoal hover:text-ivory transition-all duration-300">
            Inquire
          </a>
        </div>
  ...
  <div id="mobile-menu" class="mobile-menu fixed inset-0 z-40 bg-ivory pt-24 flex-col items-center">
    <nav class="flex flex-col items-center gap-8 py-12">
      <a href="#destinations"
        class="mobile-link text-xl font-montserrat tracking-[0.2em] text-charcoal uppercase">Destinations</a>
      <a href="#experiences"
        class="mobile-link text-xl font-montserrat tracking-[0.2em] text-charcoal uppercase">Experiences</a>
      <a href="#villas" class="mobile-link text-xl font-montserrat tracking-[0.2em] text-charcoal uppercase">Private
        Villas</a>
      <a href="#about" class="mobile-link text-xl font-montserrat tracking-[0.2em] text-charcoal uppercase">Our
        Story</a>
      <a href="#inquire"
        class="mobile-link text-xl font-montserrat tracking-[0.2em] text-charcoal uppercase">Contact</a>
      <a href="#inquire"
        class="mobile-link mt-8 px-8 py-4 border border-charcoal text-lg font-montserrat tracking-[0.15em] uppercase text-charcoal">
        Inquire Now
      </a>
    </nav>
  </div>
  ...
  <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0">
      ...
      <div class="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style="background-image: url('{{ asset('images/hero.jpg') }}');"></div>
    ...
    <div class="relative z-10 container mx-auto px-6 lg:px-12 text-center">
      <div class="max-w-4xl mx-auto animate-fade-in-up">
        <span class="inline-block text-sm md:text-base font-montserrat tracking-[0.4em] text-ivory/80 uppercase mb-6">
          Discover the Authentic Soul of Numazu & Izu
        </span>
        ...
        <p class="text-lg md:text-xl font-montserrat font-light text-ivory/90 max-w-2xl mx-auto mb-12 leading-relaxed">
          Experience a curated journey beyond the guidebook. Discover hidden spots, authentic local flavors, and the
          timeless beauty of the Izu Peninsula.
        </p>
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="#experiences"
            class="px-10 py-4 bg-ivory text-charcoal text-sm font-montserrat tracking-[0.2em] uppercase hover:bg-gold transition-colors duration-300">
            Explore Experiences
          </a>
          <a href="#inquire"
            class="px-10 py-4 border border-ivory text-sm font-montserrat tracking-[0.2em] uppercase text-ivory hover:bg-ivory hover:text-charcoal transition-all duration-300">
  ...
  <section id="destinations" class="py-24 lg:py-32 bg-ivory">
    <div class="container mx-auto px-6 lg:px-12">
      ...
      <div class="text-center mb-16 lg:mb-24">
        ...
        <p class="mt-6 text-lg font-montserrat font-light text-warm-gray max-w-2xl mx-auto">
          Each destination has been personally selected for its unique ability to inspire, transform, and create lasting
          memories
        </p>
      </div>
      ...
      <div class="destination-card group relative aspect-[4/3] overflow-hidden cursor-pointer">
        <div class="destination-image absolute inset-0 bg-cover bg-center transition-transform duration-700"
          style="background-image: url('https://images.unsplash.com/photo-1514282401047-d79a71a590e8?q=80&w=1965&auto=format&fit=crop');">
        </div>
        <div class="destination-overlay absolute inset-0 bg-charcoal/30 transition-colors duration-500"></div>
        <div class="absolute inset-0 p-8 lg:p-12 flex flex-col justify-end">
      ...
      <div class="destination-card group relative aspect-[4/3] overflow-hidden cursor-pointer">
        <div class="destination-image absolute inset-0 bg-cover bg-center transition-transform duration-700"
          style="background-image: url('https://images.unsplash.com/photo-1534445967719-8ae7b972b1a5?q=80&w=1974&auto=format&fit=crop');">
        </div>
        <div class="destination-overlay absolute inset-0 bg-charcoal/30 transition-colors duration-500"></div>
        <div class="absolute inset-0 p-8 lg:p-12 flex flex-col justify-end">
    ...
    <div class="text-center mt-16">
      <a href="#"
        class="inline-flex items-center gap-3 text-sm font-montserrat tracking-[0.2em] text-charcoal uppercase hover:text-gold transition-colors duration-300">
    ...
    <div class="container mx-auto px-6 lg:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div>
          ...
          <div class="mt-10">
            <a href="#inquire"
              class="inline-flex items-center gap-2 px-8 py-4 bg-charcoal text-ivory text-sm font-montserrat tracking-[0.2em] uppercase hover:bg-gold transition-colors duration-300">
              Craft Your Journey
            </a>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <div class="group">
            <div
              class="w-14 h-14 flex items-center justify-center border border-warm-gray/30 group-hover:border-gold transition-colors duration-300 mb-6">
              <svg class="w-6 h-6 text-charcoal group-hover:text-gold transition-colors duration-300" fill="none"
            ...
            <p class="text-sm font-montserrat text-warm-gray leading-relaxed">
              Travel in absolute comfort aboard our fleet of private jets, with every detail tailored to your
              preferences.
            </p>
          </div>
          ...
          <div class="group">
            <div
              ...
              <svg class="w-6 h-6 text-charcoal group-hover:text-gold transition-colors duration-300" fill="none"
                stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                  d="M5 3l3.5 6L12 5l3.5 4L19 3m-7 8v10m-4-6h8" />
              </svg>
            </div>
  ...
  <section id="villas" class="py-24 lg:py-32 bg-ivory">
    <div class="container mx-auto px-6 lg:px-12">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="villa-card group cursor-pointer">
          <div class="relative aspect-[3/4] overflow-hidden mb-6">
            <div class="villa-image absolute inset-0 bg-cover bg-center transition-transform duration-700"
              style="background-image: url('https://images.unsplash.com/photo-1602343168117-bb8ffe3e2e9f?q=80&w=1925&auto=format&fit=crop');">
            </div>
            <div class="absolute inset-0 bg-charcoal/10 group-hover:bg-charcoal/20 transition-colors duration-500">
            </div>
        ...
        <div class="villa-card group cursor-pointer">
          <div class="relative aspect-[3/4] overflow-hidden mb-6">
            <div class="villa-image absolute inset-0 bg-cover bg-center transition-transform duration-700"
              style="background-image: url('https://images.unsplash.com/photo-1564501049412-61c2a3083791?q=80&w=1932&auto=format&fit=crop');">
            </div>
            <div class="absolute inset-0 bg-charcoal/10 group-hover:bg-charcoal/20 transition-colors duration-500">
            </div>
            <div class="absolute top-6 right-6 bg-ivory/90 backdrop-blur-sm px-4 py-2">
        ...
        <div class="villa-card group cursor-pointer">
          <div class="relative aspect-[3/4] overflow-hidden mb-6">
            <div class="villa-image absolute inset-0 bg-cover bg-center transition-transform duration-700"
              style="background-image: url('https://images.unsplash.com/photo-1540541338287-41700207dee6?q=80&w=2070&auto=format&fit=crop');">
            </div>
            <div class="absolute inset-0 bg-charcoal/10 group-hover:bg-charcoal/20 transition-colors duration-500">
            </div>
            <div class="absolute top-6 right-6 bg-ivory/90 backdrop-blur-sm px-4 py-2">
      ...
      <div class="text-center mt-16">
        <a href="#"
          class="inline-flex items-center px-8 py-4 border border-charcoal text-sm font-montserrat tracking-[0.2em] uppercase text-charcoal hover:bg-charcoal hover:text-ivory transition-all duration-300">
          View All Properties
        </a>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div class="relative">
          ...
          <blockquote class="text-lg lg:text-xl font-light leading-relaxed mb-8 text-ivory/90">
            "Élysée Voyages transformed our anniversary trip into something beyond our wildest imagination. Every moment
            felt like a dream."
          </blockquote>
        ...
        <div class="relative">
          ...
          <blockquote class="text-lg lg:text-xl font-light leading-relaxed mb-8 text-ivory/90">
            "The level of personalization and attention to detail is unmatched. They understood exactly what we were
            looking for."
          </blockquote>
          <div class="flex items-center gap-4">
            <div class="w-12 h-12 rounded-full bg-gold/20 flex items-center justify-center">
        ...
        <div>
          <form class="space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label class="block text-sm font-montserrat text-warm-gray uppercase tracking-wider mb-3">Full
                  Name</label>
                <input type="text" required
                  class="w-full px-4 py-4 bg-ivory border border-warm-gray/30 text-charcoal font-montserrat focus:border-gold focus:outline-none transition-colors"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                <label class="block text-sm font-montserrat text-warm-gray uppercase tracking-wider mb-3">Desired
                  Destination</label>
                <input type="text"
                  class="w-full px-4 py-4 bg-ivory border border-warm-gray/30 text-charcoal font-montserrat focus:border-gold focus:outline-none transition-colors"
            ...
            <div>
              <label class="block text-sm font-montserrat text-warm-gray uppercase tracking-wider mb-3">Tell Us About
                Your Dream Journey</label>
              <textarea rows="5"
                class="w-full px-4 py-4 bg-ivory border border-warm-gray/30 text-charcoal font-montserrat focus:border-gold focus:outline-none transition-colors resize-none"
                placeholder="Share your vision, preferences, and any special requirements..."></textarea>
            </div>

            <button type="submit"
              class="w-full sm:w-auto flex items-center justify-center gap-3 px-10 py-4 bg-charcoal text-ivory text-sm font-montserrat tracking-[0.2em] uppercase hover:bg-gold transition-colors duration-300">
              Send Inquiry
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                  d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
    ...
    <div class="container mx-auto px-6 lg:px-12 py-20">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
        ...
        <div class="lg:col-span-2">
          ...
          <div class="flex items-center gap-4">
            <a href="#"
              class="w-10 h-10 flex items-center justify-center border border-ivory/30 hover:border-gold hover:text-gold transition-colors duration-300">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Europe</a>
            </li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Asia</a>
            </li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Middle
                East</a></li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Americas</a>
            </li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Africa</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Private
                Aviation</a></li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Yacht
                Charters</a></li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Villa
                Rentals</a></li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Concierge</a>
            </li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Corporate
                Travel</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="#about"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Our
                Story</a></li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Team</a>
            </li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Careers</a>
            </li>
            <li><a href="#"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Press</a>
            </li>
            <li><a href="#inquire"
                class="text-sm font-montserrat text-ivory/70 hover:text-gold transition-colors duration-300">Contact</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container mx-auto px-6 lg:px-12 py-6">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-6">
            <a href="#" class="text-xs font-montserrat text-ivory/50 hover:text-ivory transition-colors">Privacy
              Policy</a>
            <a href="#" class="text-xs font-montserrat text-ivory/50 hover:text-ivory transition-colors">Terms of
              Service</a>
          </div>
        </div>
      </div>
